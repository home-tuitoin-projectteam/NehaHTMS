		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						...
						<div class="logo_container">
							<div class="logo">
							<img  src="<?= base_url().'assets/' ?>images/banner/logo.png" alt="">
								<span>Neha Home Tuition</span>
							</div>
						</div>
			...
			<div class="footer_bar d-flex flex-column flex-sm-row align-items-center">
				<div class="footer_copyright">
					<span>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by Neha Home Tusion | This website is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="http://www.infinitysoftech.com" target="_blank">Infinity Softech</a>
</span>
				</div>
...
<!-- <script src="https://goo.gl/maps/pxgttnfdoWQH4xhC6"></script> -->
